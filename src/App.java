       ...
       // GUARDAR NOVO CLIENTE
        ...
        server.createContext("/editar", exchange -> {
            ...
            try {
                ...
                html.append("Telefone:<input name='pais' value='").append(telefone).append("'>");
            ...
            try {
                ...
                for (String p : params) {
                    ...
                    if (kv.length == 2) {
                        ...
                        switch (key) {
                            case "numeroCA": idStr = value; break;
                            case "nomeAnimal": nome = value; break;
                            case "dataNascimento": email = value; break;
                        }
                    }
                }
